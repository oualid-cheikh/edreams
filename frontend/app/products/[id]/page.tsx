          ...
          <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
            <div className="bg-gradient-to-r from-[#6B9AB6] to-[#5A8AA5] p-8">
              ...
              <div className="flex items-center text-white/90">
                ...
                <span>
                  Disponible depuis le {formatDate(product.createdAt)}
                </span>
              </div>
            </div>
            ...
            <div className="p-8">
              ...
              <div className="mt-8 pt-8 border-t border-gray-200">
                ...
                <p className="text-gray-600 leading-relaxed">
                  {product.name} est un produit de haute qualité conçu pour
                  répondre à tous vos besoins. Profitez d'une expérience
                  exceptionnelle avec ce produit premium qui allie performance,
                  design élégant et fiabilité. Idéal pour un usage quotidien, ce
                  produit vous accompagnera dans toutes vos activités.
                </p>
              </div>
            </div>
          </div>
