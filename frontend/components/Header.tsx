        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-6">
              ...
              {isProductsOpen && (
                <div className="absolute top-full left-0 mt-2 w-64 bg-white rounded-lg shadow-xl py-2 border border-gray-100">
                  <div className="px-4 py-2 border-b border-gray-100">
                    <p className="text-xs font-semibold text-gray-500 uppercase">Catégories</p>
                  </div>
            ...
            <div className="relative" ref={aboutRef}>
              ...
              {isAboutOpen && (
                <div className="absolute top-full right-0 mt-2 w-80 bg-white rounded-lg shadow-xl p-6 border border-gray-100">
                  <h3 className="text-lg font-bold text-gray-900 mb-3">eDreams Factory</h3>
                  <p className="text-gray-600 text-sm leading-relaxed">
                    Spécialiste de la vente en ligne de produits high-tech. Nous proposons une sélection 
                    d'équipements pour gamers et professionnels : claviers, souris, écrans, casques et webcams 
                    de qualité premium.
                  </p>
                  <div className="mt-4 pt-4 border-t border-gray-100">
                    <p className="text-xs text-gray-500">🎯 Votre setup, notre passion</p>
                  </div>
                </div>
              )}
            </div>
            ...
            <div className="relative" ref={contactRef}>
              ...
              >
                CONTACT
                <svg className={`w-4 h-4 transition-transform ${isContactOpen ? 'rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </button>
              ...
              {isContactOpen && (
                <div className="absolute top-full right-0 mt-2 w-72 bg-white rounded-lg shadow-xl p-6 border border-gray-100">
                  <h3 className="text-lg font-bold text-gray-900 mb-4">Contactez-nous</h3>
